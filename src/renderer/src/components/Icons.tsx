...
export function SourceControlIcon(): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
      ...
      <path d="M6 8.5V15.5" />
      <path d="M8.3 7.3C11 8.5 12.5 9.7 15.7 10.7" />
    </svg>
  )
}

export function RunIcon(): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
...
export function ExtensionsIcon(): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
      <path d="M14 3h-4v3.5a1.5 1.5 0 0 1-3 0V3H4v6.5H1a1.5 1.5 0 0 0 0 3H4V19h6.5a1.5 1.5 0 0 1 0 3v-3h6.5a1.5 1.5 0 0 0 0-3H20V9.5a1.5 1.5 0 0 0-3 0H14V3z" />
    </svg>
  )
}
...
export function WarningIcon(): JSX.Element {
  return (
    <svg viewBox="0 0 16 16" fill="currentColor" width="13" height="13">
      <path d="M8 1L15 14H1L8 1z" fillOpacity="0" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" />
      <circle cx="8" cy="11.3" r="0.8" />
      <path d="M8 5.5v3.5" stroke="currentColor" strokeWidth="1.3" />
    </svg>
  )
}
...
export function CopyIcon(): JSX.Element {
  return (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" width="12" height="12">
      ...
      <path d="M3 10.5V3.7C3 3.3 3.3 3 3.7 3h6.8" />
    </svg>
  )
}
